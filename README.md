...
<html >
    ...
    <body >
        <center>
            <img src= "saveetha.png" height = "200" width="1000>">
        </center>
        <table align="Center" border="3">
            <caption><b>My Time Table (ASTLEJOE A S- 212224240019)</b></caption>
            <tr  bgcolor="green" cellspacing="10" cellpadding="20">
                <th>Day/Time</th>
                <th>Monday</th>
                <th>Tuesday</th>
                <th>Wednesday</th>
    ...
    <body>
        ...
        <caption><b>My courses</b></caption>
            ...
            <tr>
                ...
                <td bgcolor="blue">Fundamentals of web application development (FWAD)</td>
            </tr>
            <tr>
                <th bgcolor="Purple">2</th>
                <td  bgcolor="Violet">19AI301C</td>
                <td  bgcolor=" blue">Python adn Linear Algebra</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td  bgcolor="blue ">Principle of Chemistry in Engineeing </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td  bgcolor="blue">Carrer development skill(Soft skill)</td>
            </tr>
        </table>
    </body>
</html>
...
## OUTPUT
![Screenshot from 2025-04-21 12-40-09](https://github.com/user-attachments/assets/586eb549-b870-4ab3-aa23-a4747caa96da)
